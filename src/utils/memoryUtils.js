...
var Operations = {
  ...
  UPDATE_GROUP: "更新分组",
  DELETE_GROUP: "删除分组",
  MANAGE_DISTRIBUTION_POINT: "兑换门店管理",
  ...
  TRANSFER_CUSTOMER: "客户移交",
  MANAGE_TAG: "标签管理",
  LIST_TAGS: "查看标签",
  CREATE_TAG: "新增标签",
  DELETE_TAG: "删除标签",
  MANAGE_RESOURCE: "资源需求管理", //商品库管理 需求管理
