...
const CouponManagement = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const { data } = await reqGetCoupons(params);
      console.log(data);
                ...
                <Popover
                  ...
                  content={
                    <>
                      ...
                      <Divider type="vertical" />
                      <b className="ant-blue-link cursor">注销</b>
                      <Divider type="vertical" />
...
//           during: [cont[i].effective, comEvents.formatExpiry(cont[i].expiry)],
//           status: cont[i].status,
//           campaign: cont[i].campaign,
//         });
//       }
...
//   };
//   render() {
//     return <div>{this.state.inited ? this.renderContent() : <Loading />}</div>;
//   }
// }
